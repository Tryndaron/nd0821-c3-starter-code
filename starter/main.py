...
lr_model = load('Kurs4_final_project/nd0821-c3-starter-code/starter/model/lr_model.joblib')
encoder = load('Kurs4_final_project/nd0821-c3-starter-code/starter/model/encoder_path.joblib')
lb = load('Kurs4_final_project/nd0821-c3-starter-code/starter/model/lb_path.joblib')
